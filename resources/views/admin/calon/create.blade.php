            ...
            <form role="form" method="post" action="/admin/calon/store" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_panggilan" id="nama" placeholder="Enter nama Panggilan">
                  </div>
                  <div class="form-group">
                    <label for="visi">Visi</label>
                    <textarea name="visi" id="editor1" name="visi" class="form-control" rows="10" cols="80" placeholder="Masukkan Visi">
                    </textarea>
                  </div>
                  <div class="form-group">
                    <label for="misi">Misi</label>
                    <textarea name="misi" id="editor1" name="misi" class="form-control" rows="10" cols="80" placeholder="Masukkan Misi">
                    </textarea>
                  </div>
                  <div class="form-group">
